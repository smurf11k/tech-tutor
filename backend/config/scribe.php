...
$scribePresent = class_exists(\Knuckles\Scribe\Scribe::class);
$scribeAuthIn = $scribePresent && class_exists(AuthIn::class) ? AuthIn::BEARER->value : 'bearer';
$scribeStrategies = $scribePresent ? [
    'metadata' => [
